    ...
    <div class="container1">
        <div class="card1">
            ...
            <form @submit.prevent="handleLogin">
                ...
                <div class="inputcontainer">
                    <span style="position: relative; width: 100%;">
                        <input :type="showPassword ? 'text' : 'password'" name="Senha" id="password" placeholder="Senha"
                            v-model="password" @input="handleChangePassword" maxlength="25"
                            style="padding-left: 38px;" />
                        <label for="password"
...
#app {
    ...
    height: 100%;
    overflow: hidden;
    /* Adicione isso para evitar overflow */
}
...
.container1 {
    ...
    width: 100%;
    height: 100vh;
    /* Alterado para 100vh para garantir que ocupe a altura total da viewport */
